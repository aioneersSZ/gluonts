...
from ._network import (
    FeedForwardDistributionNetwork,
    FeedForwardSamplingNetwork,
    FeedForwardTrainingNetwork,
)


class FeedForwardEstimator(GluonEstimator):
    """
    FeedForwardEstimator shows how to build a simple MLP model predicting
    ...
    def create_predictor(self, transformation, trained_network):
        ...
        if self.sampling is True:
            prediction_network = FeedForwardSamplingNetwork(
                num_hidden_dimensions=self.num_hidden_dimensions,
                prediction_length=self.prediction_length,
                context_length=self.context_length,
                distr_output=self.distr_output,
            ...
            prediction_network = FeedForwardDistributionNetwork(
                num_hidden_dimensions=self.num_hidden_dimensions,
                prediction_length=self.prediction_length,
                context_length=self.context_length,
                distr_output=self.distr_output,
